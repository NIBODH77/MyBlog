    ...
    <div className="h-screen bg-gradient-to-b from-amber-50 to-white flex flex-col overflow-hidden">
      ...
      <div className="bg-amber-50 px-3 py-2 flex items-center justify-between border-b border-gray-200 flex-shrink-0">
        ...
        <div className="flex-1 flex justify-center">
          <h1 className="text-xl md:text-2xl font-serif text-red-700">MyBlog+</h1>
        </div>
      ...
      <div className="flex-1 max-w-4xl w-full mx-auto px-3 py-2 overflow-y-auto scrollbar-hide">
        <div className="h-full flex flex-col justify-between">
          ...
          <div className="space-y-2">
            ...
            <h2 className="text-lg md:text-xl font-bold text-center text-gray-900">Join MyBlog+</h2>
            ...
            <div className="grid grid-cols-3 gap-1.5 md:gap-2">
              <div className="bg-amber-50 rounded-lg p-1.5 md:p-2 border border-amber-100">
                ...
                <p className="text-[10px] md:text-xs font-medium text-gray-800 text-center">Ad-free browsing</p>
              </div>
              ...
              <div className="bg-amber-50 rounded-lg p-1.5 md:p-2 border border-amber-100">
                ...
                <p className="text-[10px] md:text-xs font-medium text-gray-800 text-center">Unlimited content</p>
              </div>
              ...
              <div className="bg-amber-50 rounded-lg p-1.5 md:p-2 border border-amber-100">
                ...
                <p className="text-[10px] md:text-xs font-medium text-gray-800 text-center">30 days free</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-1.5 md:gap-2">
              ...
              >
                <div className="flex items-start justify-between mb-0.5 md:mb-1">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-xs md:text-sm font-semibold text-gray-900">Yearly</span>
                  </div>
                ...
                <div className="ml-4 md:ml-5">
                  <p className="text-sm md:text-base font-bold text-blue-600">$3.99/mo</p>
                </div>
              </button>
              ...
              >
                <div className="flex items-center gap-1 mb-0.5 md:mb-1">
                  ...
                  <span className="text-xs md:text-sm font-semibold text-gray-900">Monthly</span>
                </div>
                <div className="ml-4 md:ml-5">
                  <p className="text-sm md:text-base font-bold text-gray-600">$6.99/mo</p>
                </div>
              </button>
            </div>
          </div>
          ...
          <div className="space-y-1.5 md:space-y-2 pb-2">
            ...
            <div className="flex justify-between items-center px-1 text-xs md:text-sm">
              <span className="font-semibold text-gray-900">30-day free trial</span>
              <span className="font-semibold text-gray-900">$0.00</span>
            </div>

            <div className="flex justify-between items-center px-1">
              <span className="text-[10px] md:text-xs text-gray-600">Starting Jan 9, 2026</span>
            ...
            <div className="space-y-1.5">
              <button className="w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-1.5 md:py-2 rounded-lg flex items-center justify-center gap-1 transition-colors text-xs md:text-sm">
                Pay with <span className="font-bold text-sm md:text-base">◉ link</span>
              </button>
              ...
              <button className="w-full bg-yellow-400 hover:bg-yellow-500 text-blue-800 font-bold py-1.5 md:py-2 rounded-lg transition-colors text-xs md:text-sm">
                ...
                <span className="text-sm md:text-base text-blue-600">Pal</span>
              </button>
            </div>

            <div className="text-center text-gray-400 font-semibold text-[10px] md:text-xs">OR</div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-2 py-1.5 md:py-2 border-2 border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none text-xs md:text-sm"
              />
              <button className="absolute right-2 top-1/2 -translate-y-1/2 bg-black text-green-400 px-1.5 md:px-2 py-0.5 md:py-1 rounded-lg font-semibold text-[10px] md:text-xs hover:bg-gray-800 transition-colors">
                Autofill <span className="font-bold">link</span>
              </button>
            </div>

            {/* Submit Button */}
            <button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm md:text-base py-2 md:py-2.5 rounded-xl transition-colors shadow-lg">
              Try 30 Days Free
            </button>
          </div>
        </div>
