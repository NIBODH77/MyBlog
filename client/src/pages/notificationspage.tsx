...
import { Bell, MessageSquare, Users, TrendingUp, Award, DollarSign, Zap, User } from 'lucide-react';
...
export default function MyBlogNotificationsPage() {
  ...
  const notifications: Notification[] = [
    ...
    },
    {
      ...
      message: 'A story you might like is trending: "10 Tips for Better Productivity"',
      time: '5 hours ago',
      read: false
    },
