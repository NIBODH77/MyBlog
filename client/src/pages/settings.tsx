    ...
    <div className="min-h-screen bg-gray-50 pb-16 md:pb-0">
      ...
      <div className="max-w-7xl mx-auto px-3 md:px-4 py-4 md:py-6">
        <div className="flex flex-col md:flex-row gap-4 md:gap-8">
          {/* Left Sidebar */}
          <aside className="md:sticky md:top-20 h-fit w-full md:w-64 md:flex-shrink-0">
          ...
          {/* Main Content */}
          <main className="flex-1 w-full md:max-w-3xl">
            <h1 className="text-xl md:text-2xl font-semibold text-gray-900 mb-4 md:mb-6">Account Settings</h1>
                ...
                <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-3">
                  <div className="flex-1">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                      <span className="text-sm text-gray-900 break-all">lolu4224@gmail.com</span>
            ...
            <div className="mt-6 md:mt-8">
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 mb-4">
                <h2 className="text-base md:text-lg font-semibold text-gray-900">Connected Accounts & Contacts</h2>
                <a href="#" className="text-xs text-gray-400 hover:underline">
                  Learn more
                </a>
              </div>
                ...
                <div className="p-4 md:p-6">
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
                    ...
                    <div className="text-left sm:text-right">
                      <div className="text-sm text-gray-900 break-all">lolu4224@gmail.com</div>
