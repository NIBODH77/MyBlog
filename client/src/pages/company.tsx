  ...
  return (
    <AppShell hideRightSidebar>
      <div className="max-w-4xl mx-auto">
        {/* Hero Section */}
        <div className="bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 rounded-xl shadow-2xl p-12 mb-8 text-white text-center relative overflow-hidden">
        ...
        <div className="bg-white dark:bg-card rounded-xl shadow-lg p-8 mb-6 border border-orange-100 dark:border-orange-900/30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-8 bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-950/40 dark:to-orange-900/40 rounded-xl border-2 border-orange-200 dark:border-orange-800 hover:scale-105 transition-transform shadow-sm">
              <div className="text-5xl font-extrabold bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent mb-3">300M+</div>
              <div className="text-sm font-semibold text-gray-700 dark:text-muted-foreground">Monthly Active Users</div>
            </div>
            <div className="text-center p-8 bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-950/40 dark:to-orange-900/40 rounded-xl border-2 border-orange-200 dark:border-orange-800 hover:scale-105 transition-transform shadow-sm">
              <div className="text-5xl font-extrabold bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent mb-3">50K+</div>
              <div className="text-sm font-semibold text-gray-700 dark:text-muted-foreground">Topics & Spaces</div>
            </div>
            <div className="text-center p-8 bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-950/40 dark:to-orange-900/40 rounded-xl border-2 border-orange-200 dark:border-orange-800 hover:scale-105 transition-transform shadow-sm">
              <div className="text-5xl font-extrabold bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent mb-3">1B+</div>
        ...
        <div className="bg-white dark:bg-card rounded-xl shadow-lg p-8 mb-6 border border-orange-100 dark:border-orange-900/30">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-950/30 dark:to-orange-900/30 p-6 rounded-xl border border-orange-200 dark:border-orange-800 shadow-sm">
        ...
        {/* Contact & Links */}
        <div className="bg-gradient-to-br from-orange-50 via-orange-100 to-orange-50 dark:from-orange-950/30 dark:via-orange-900/30 dark:to-orange-950/30 rounded-xl shadow-lg p-10 border-2 border-orange-200 dark:border-orange-800">
