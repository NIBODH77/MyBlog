  ...
  return (
    <AppShell hideRightSidebar>
      <div className="max-w-4xl mx-auto">
        {/* Hero Section */}
        <div className="bg-gradient-to-br from-blue-600 via-indigo-600 to-orange-600 rounded-xl shadow-2xl p-12 mb-8 text-white text-center relative overflow-hidden">
        ...
        <div className="bg-white dark:bg-card rounded-xl shadow-lg p-8 mb-6 border border-blue-100 dark:border-blue-900/30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center p-8 bg-gradient-to-br from-indigo-50 to-orange-50 dark:from-indigo-950/40 dark:to-orange-950/40 rounded-xl border-2 border-indigo-200 dark:border-indigo-800 hover:scale-105 transition-transform shadow-sm">
              <div className="text-5xl font-extrabold bg-gradient-to-r from-indigo-600 to-orange-600 bg-clip-text text-transparent mb-3">50K+</div>
              <div className="text-sm font-semibold text-gray-700 dark:text-muted-foreground">Topics & Spaces</div>
            </div>
            <div className="text-center p-8 bg-gradient-to-br from-orange-50 to-blue-50 dark:from-orange-950/40 dark:to-blue-950/40 rounded-xl border-2 border-orange-200 dark:border-orange-800 hover:scale-105 transition-transform shadow-sm">
              <div className="text-5xl font-extrabold bg-gradient-to-r from-orange-600 to-blue-600 bg-clip-text text-transparent mb-3">1B+</div>
        ...
        <div className="bg-white dark:bg-card rounded-xl shadow-lg p-8 mb-6 border border-blue-100 dark:border-blue-900/30">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-orange-50 dark:from-indigo-950/30 dark:to-orange-950/30 p-6 rounded-xl border border-indigo-200 dark:border-indigo-800 shadow-sm">
              <div className="flex items-start gap-3 mb-4">
                <div className="w-10 h-10 bg-gradient-to-br from-indigo-500 to-orange-600 rounded-lg flex items-center justify-center flex-shrink-0 shadow-lg">
        ...
        <div className="bg-white dark:bg-card rounded-xl shadow-lg p-8 mb-6 border border-blue-100 dark:border-blue-900/30">
          <div className="flex items-start gap-4 mb-6">
            <div className="w-12 h-12 bg-gradient-to-br from-indigo-500 to-orange-600 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg">
        ...
        {/* Contact & Links */}
        <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-orange-50 dark:from-blue-950/30 dark:via-indigo-950/30 dark:to-orange-950/30 rounded-xl shadow-lg p-10 border-2 border-blue-200 dark:border-blue-800">
          ...
          <div className="flex flex-wrap gap-3 justify-center mb-6">
            ...
            <Button variant="outline" className="border-orange-300 hover:bg-orange-50 dark:hover:bg-orange-950/50 text-orange-700 dark:text-orange-300" asChild>
